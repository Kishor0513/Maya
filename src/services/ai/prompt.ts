...
export function buildSystemPrompt(
  ...
  return [
    ...
    '- If you need current information beyond your training, emit a line exactly like: [SEARCH: your query]. The gateway runs the search and returns results; then answer using them.',
